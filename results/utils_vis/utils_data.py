...
from utils_vis.utils_method import METHOD_ABLATION_INFO
from utils_vis.utils_task import LOCOMOTION_TASK_INFO, MANIPULATION_TASK_INFO, ABLATION_TASK_INFO
...
def load_flam_ablation_results(
    ...
    task_results = defaultdict(dict)
    for task in ABLATION_TASK_INFO.keys():
        file_dir = os.path.join(dir_path, task)
        for method in METHOD_ABLATION_INFO.keys():
