...
ABLATION_TASK_INFO = {
    ...
    'Stand': {'ID': 1, 'yticks': (0, 1100, 250), 'ylim': (0, 1000), 'success': 750},
    'Run': {'ID': 2, 'yticks': (0, 1100, 250), 'ylim': (0, 1000), 'success': 750},
    'Door': {'ID': 3, 'yticks': (0, 600, 125), 'ylim': (0, 500), 'success': 375},
}
...
def get_task_info(
        task_name,
        task_type: Literal['locomotion', 'manipulation', 'ablation'] = 'locomotion'
):
    ...
    elif task_type == 'ablation' and task in ABLATION_TASK_INFO:
        task_info = ABLATION_TASK_INFO[task]
    else:
        task_info = None
    return task_info
