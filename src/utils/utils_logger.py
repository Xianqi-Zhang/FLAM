"""
Code: https://github.com/nicklashansen/tdmpc2/blob/vectorized_env/tdmpc2/common/logger.py
"""
import os
import datetime
import re
...
class VideoRecorder:
    ...
    def __init__(self, cfg, wandb, fps=15):
        self.cfg = cfg
        self._save_dir = os.path.join(cfg.work_dir, 'eval_video')
...
class Logger:
    ...
    def __init__(self, cfg):
        ...
        self._model_dir = os.path.join(self._log_dir, 'models')
        ...
        if cfg.disable_wandb or self.project is None or self.entity is None:
