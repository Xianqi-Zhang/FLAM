...
from src.pkgs.RoHM.train.training_loop_trajnet import TrainLoopTrajNet
...
from src.pkgs.RoHM.diffusion.respace import SpacedDiffusionTrajNet
...
def main(args, writer, logdir, logger):
    ...
    train_dataset = DatasetAMASS(preprocessed_amass_root=args.dataset_root, split='train',
    ...
    test_dataset = DatasetAMASS(preprocessed_amass_root=args.dataset_root, split='test',
                                spacing=2,
