...
from src.pkgs.RoHM.diffusion.respace import SpacedDiffusionPoseNet
...
def main(args, writer, logdir, logger):
    ...
    test_dataset = DatasetAMASS(preprocessed_amass_root=args.dataset_root, split='test', spacing=2,
