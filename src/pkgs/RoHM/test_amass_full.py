...
from src.pkgs.RoHM.utils.fixseed import fixseed
...
from src.pkgs.RoHM.diffusion import gaussian_diffusion_posenet
from src.pkgs.RoHM.model.trajnet import TrajNet
from src.pkgs.RoHM.diffusion import gaussian_diffusion_trajnet
...
group.add_argument('--dataset_root', type=str, default='./datasets/AMASS_smplx_preprocessed', help='path to datas')
...
def main(args):
    ...
    test_pose_dataset = DatasetAMASS(preprocessed_amass_root=args.dataset_root, split='test',
    ...
    test_traj_dataset = DatasetAMASS(preprocessed_amass_root=args.dataset_root, split='test',
                                     amass_datasets=amass_test_datasets,
                                     body_model_path=args.body_model_path,
