...
REPR_LIST = [
    ...
    'root_l_pos',
    'root_l_vel',
    'root_height', # joint-based traj

    'smplx_rot_6d',
    'smplx_rot_vel',
    'smplx_trans',
    'smplx_trans_vel',  # smplx-based traj

    'local_positions',
    'local_vel',  # joint-based local pose

    'smplx_body_pose_6d',  # smplx-based local pose
    'smplx_betas',  # smplx body shape
    'foot_contact',  # [foot contact labels]
]
# dimension for each category of the motion representation
REPR_DIM_DICT = {  # * 294-dim total
    # * 22-dim
    'root_rot_angle': 1,  # * root angular rotation
    'root_rot_angle_vel': 1,
    'root_l_pos': 2, # *  root (pelvis) linear position
    'root_l_vel': 2,
    'root_height': 1,  # * root height
    'smplx_rot_6d': 6,  # * SMPL-X global orientation
    'smplx_rot_vel': 3,
    'smplx_trans': 3,  # * SMPL-X global translation
    'smplx_trans_vel': 3,

    # * 272-dim
    'local_positions': 22 * 3,
    'local_vel': 22 * 3,
    'smplx_body_pose_6d': 21 * 6,  # * joint rotations
    'smplx_betas': 10,  # * smplx body shape
    'foot_contact': 4,  # * foot contact labels f ∈ {0, 1}
}
...
def update_globalRT_for_smplx(body_param_dict, trans_to_target_origin, smplx_model=None,
                              device=None, delta_T=None):
    '''
    input:
        body_param_dict:
